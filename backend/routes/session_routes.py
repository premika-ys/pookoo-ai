...
# # (simple lookup in users table by token)
# # We store token→email mapping on login.
# # =========================================
...
#         cursor.execute("""
#             INSERT INTO sessions (session_id, user_email, title, updated_at)
#             VALUES (?, ?, ?, ?)
#             ON CONFLICT(session_id, user_email)
...
# # LIST SESSIONS
# # GET /sessions/list
# # Called on app mount to restore sidebar
# # =========================================
...
# # =========================================
# # DELETE SESSION (frontend-only safe)
