...
// // export default function Sidebar({ isOpen, onClose, onOpenSummary, onOpenQuiz, activePanelType })
...
//   activePanelType
// }) {
//   const { sessions, currentSession, createSession, switchSession, uploadedPdfs } = useContext(ChatContext);
...
//                 <div key={pdf.filename || pdf.id || i} className="sidebar-pdf-item">
